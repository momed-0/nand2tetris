...
SymbolTable::SymbolTable() {
    ...
    at RAM address 16  */
    VariableCounter = 16;
    LabelCounter = 0;//for the first pass -- points to the current ROM Address
}
...
uint16_t SymbolTable::incLabelCounter() {  // increament label counter
    return ++LabelCounter;
}


//add label if it exists throw a error
